...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      $message[] = 'You`ve entered incorrect username or password';
   }
...
<!-- headchef login form section starts  -->
<section class="form-container">

   <form action="" method="POST">
      <h3>Sign In as HeadChef</h3>
...
<!-- headchef login form section ends -->
