...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="number" step="0.01" min="0" max="9999999999" required placeholder="Menu Price" name="price" class="box">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">Update</a>
       		<!-- <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this menu?');">Delete</a> -->
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <a href="products.php?delete=<?= $fetch_products['id']; ?>" type="button" class="btn btn-primary">Confirm</a>
            </div>
         </div>
      </div>
   </div>
